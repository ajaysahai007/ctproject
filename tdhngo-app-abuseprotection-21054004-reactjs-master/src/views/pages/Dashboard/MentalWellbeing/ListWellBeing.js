...
export default function () {
  ...
  console.log("765726t76234-->>", type);
  //MENTAL HEALTH & WELL BEING
  const MentalBellBeing = async () => {
    try {
      setLoading(true);
      const res = await axios({
        url: apiConfig.listMentalAndWellBeingData,
        method: "GET",
        headers: {
          token: token,
        },
  ...
  const BlockActivityFunction = async () => {
    ...
    try {
      const res = await axios({
        url: apiConfig.blockMentalAndWellBeingData,
        headers: {
          token: token,
        },
        method: "PUT",
      ...
      <Box mt={3}>
        ...
        <Box mt={3} display="flex" justifyContent="space-between">
          ...
          <Button
            ...
            onClick={() =>
              history.push({
                pathname: "/mental-well-being-section",
                search: "Add",
                state: {
                    ...
                    return (
                      <>
                        <StyledTableRow>
                          ...
                          <TableCell>{data.article_name}</TableCell>
                          <TableCell>
                            <iframe
                              style={{
                                width: "150px",
                              ...
                              src={data?.url ? data?.url : data?.video}
                            ></iframe>
                          </TableCell>
